        ...
        <div class="card">
            ...
            <form action="insert_loan.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" id="interest_rate" name="interest_rate" class="form-control" value="5.00" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="repayment_date" name="repayment_date" class="form-control" required>
                </div>
                <div class="form-group">
